...
const routes: Routes = [
  ...
  //Nguoidung-chitiet
  { path: 'chitiet-nguoidung', component: ChitietNguoidungComponent },

  //Hoso
  { path: 'hoso-sinhvien', component: HosoSinhvienComponent },
  { path: 'hoso-nhatuyendung', component: HosoNhatuyendungComponent },
